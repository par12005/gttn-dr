 ...
 * 
 * @param $string string The input that the user has already provided to the autocomplete field.
 */
 ...
 * 
 * @param $form array The newly built form.
 * @param $form_state array The state of the newly built form.
